...
foreach(app but_uts but_mts but_its)
  ...
  if(${CATCH2_VERSION_MAJOR} EQUAL 3)
    target_link_libraries(${app} Catch2Main Catch2)
    set(CTEST_CATCH2_FLAGS --order rand --colour-mode ansi)
  elseif(${CATCH2_VERSION_MAJOR} EQUAL 2)
    target_link_libraries(${app} Catch2WithMain)
    set(CTEST_CATCH2_FLAGS --order rand --use-colour yes)
  else()
    message(FATAL_ERROR "unknown version of Catch2: ${CATCH2_VERSION_MAJOR}")
  endif()
  target_link_libraries(${app} boost_serialization boost_chrono)
  add_test(NAME run_${app}
           COMMAND ${CMAKE_CURRENT_BINARY_DIR}/${app} ${CTEST_CATCH2_FLAGS})
