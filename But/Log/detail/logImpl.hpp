...
#define BUT_LOG_DETAIL_LOGIMPL_BODY(pri, msg) std::stringstream ss; ss << msg; ::But::Log::detail::logProxy( ::But::Log::Priority::##pri, __FILE__, __LINE__, BOOST_PRETTY_FUNCTION, ss.str() )
